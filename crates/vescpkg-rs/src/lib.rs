...
pub(crate) mod ffi {
    ...
    pub use selected_ffi::{
        ...
        mc_get_watt_hours, mc_get_watt_hours_charged, mc_release_motor, mc_set_brake_current,
        mc_set_current, mc_set_current_off_delay, mc_set_duty, mc_set_handbrake,
        mc_set_handbrake_rel, mc_set_odometer, mc_stat_count_time, mc_stat_current_avg,
