...
pub(crate) mod ffi {
    ...
    pub use vescpkg_rs_sys::raw::{
        ...
        io_write, lbm_add_extension, lbm_dec_as_float, lbm_enc_sym_eerror, lbm_enc_sym_nil,
        lbm_enc_sym_true, vesc_clear_app_data_handler, vesc_clear_imu_read_callback, vesc_get_arg,
        vesc_malloc, vesc_send_app_data, vesc_set_app_data_handler, vesc_set_imu_read_callback,
    };
    ...
    pub use selected_ffi::{
        ...
        imu_get_yaw, imu_startup_done, lbm_dec_as_i32, lbm_dec_as_u32, lbm_dec_char, lbm_enc_char,
        lbm_enc_i, lbm_enc_u32, lbm_is_byte_array, lbm_is_char, lbm_is_cons, lbm_is_number,
