...
pub(crate) mod ffi {
    ...
    pub use vescpkg_rs_sys::raw::{lbm_get_symbol_by_name, lbm_set_error_reason};
    ...
    pub use selected_ffi::{
        ...
        lbm_get_symbol_by_name, lbm_is_symbol, lbm_list_destructive_reverse, lbm_send_message,
...
pub mod prelude {
    ...
    pub use crate::{
        ...
        FirmwareCapabilities, FirmwareInputs, FirmwareMutex, FirmwareMutexGuard,
        FirmwareSemaphore, FirmwareSettings, FirmwareThread, FirmwareThreads, Gnss, GnssError,
        GnssSnapshot, Gpio, Imu, ImuReadHandler, LbmExtension, LispArgs, LispIntegerError,
        LispValue, MotorOutput, MotorTelemetry, Nvm, NvmCapacity, NvmError, NvmOffset,
        PackageRuntimeState, PackageStart, PackageStartError, PacketCodec, PacketError,
