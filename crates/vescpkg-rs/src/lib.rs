...
pub(crate) mod ffi {
    ...
    pub use selected_ffi::{
        ...
        foc_get_iq, foc_get_vd, foc_get_vq, get_cfg_float, get_cfg_int, imu_get_gyro,
        ...
        mc_get_distance, mc_get_distance_abs, mc_get_duty_cycle_now, mc_get_fault,
        mc_get_input_voltage_filtered, mc_get_odometer, mc_get_pid_pos_now, mc_get_pid_pos_set,
        mc_get_rpm, mc_get_sampling_frequency_now, mc_get_speed, mc_get_tachometer_abs_value,
        ...
        mc_get_watt_hours_charged, mc_release_motor, mc_set_brake_current, mc_set_current,
        mc_set_current_off_delay, mc_set_duty, mc_set_handbrake, mc_set_handbrake_rel,
        mc_set_odometer, mc_set_pid_pos, mc_set_pid_speed, mc_stat_count_time, mc_stat_current_avg,
        ...
        mc_temp_motor_filtered, mc_update_pid_pos_offset, mc_wait_for_motor_release,
