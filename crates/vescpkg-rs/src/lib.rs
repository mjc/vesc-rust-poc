...
pub(crate) mod ffi {
    ...
    pub use selected_ffi::{
        ...
        lbm_start_flatten, lbm_unblock_ctx, lbm_unblock_ctx_unboxed, mc_dccal_done,
        ...
        mc_get_input_voltage_filtered, mc_get_motor_thread, mc_get_odometer, mc_get_pid_pos_now,
        ...
        plot_set_graph, read_eeprom_word, read_nvm, set_cfg_float, set_cfg_int, shutdown_disable,
        store_cfg, store_eeprom_word, terminal_register_command_callback,
