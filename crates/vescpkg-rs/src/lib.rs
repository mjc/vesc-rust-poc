...
pub(crate) mod ffi {
    ...
    pub use vescpkg_rs_sys::raw::{
        ...
        can_status_msg_2_id, can_status_msg_id, can_transmit_eid, can_transmit_sid,
    };
    ...
    pub use crate::test_ffi::{
        can_ping, can_set_current, can_set_current_rel, can_set_duty, can_set_pos, can_set_rpm,
        can_status_msg_2_id, can_status_msg_id, can_transmit_eid, can_transmit_sid, io_read,
...
pub use can_bus::{CanBus, CanError, CanHardwareType, CanStatus, CanStatus2};
