...
pub(crate) mod ffi {
    ...
    pub use selected_ffi::{
        ...
        imu_get_calibration, imu_get_gyro, imu_get_gyro_derotated, imu_get_mag, imu_get_pitch,
        imu_get_roll, imu_get_rpy, imu_get_yaw, imu_set_read_callback, imu_set_yaw,
        imu_startup_done, lbm_block_ctx_from_extension, lbm_car, lbm_cdr, lbm_cons,
        lbm_continue_eval, lbm_create_byte_array, lbm_dec_as_float, lbm_dec_as_i32, lbm_dec_as_u32,
        lbm_dec_char, lbm_dec_str, lbm_dec_sym, lbm_enc_char, lbm_enc_float, lbm_enc_i,
        lbm_enc_sym, lbm_enc_u32, lbm_eval_is_paused, lbm_finish_flatten, lbm_get_current_cid,
        lbm_get_symbol_by_name, lbm_is_byte_array, lbm_is_char, lbm_is_cons, lbm_is_number,
        lbm_is_symbol, lbm_list_destructive_reverse, lbm_pause_eval_with_gc, lbm_send_message,
        lbm_set_error_reason, lbm_start_flatten, lbm_unblock_ctx, lbm_unblock_ctx_unboxed,
        ...
        mc_set_pwm_callback, mc_set_tachometer_value, mc_stat_count_time, mc_stat_current_avg,
        mc_stat_current_max, mc_stat_power_avg, mc_stat_power_max, mc_stat_reset,
        mc_stat_speed_avg, mc_stat_speed_max, mc_stat_temp_mosfet_avg, mc_stat_temp_mosfet_max,
        mc_stat_temp_motor_avg, mc_stat_temp_motor_max, mc_temp_fet_filtered,
        mc_temp_motor_filtered, mc_update_pid_pos_offset, mc_wait_for_motor_release, packet_init,
        packet_process_byte, packet_reset, packet_send_packet, plot_add_graph, plot_init,
        plot_send_points, plot_set_graph, read_eeprom_word, read_nvm, set_cfg_float, set_cfg_int,
        shutdown_disable, store_cfg, store_eeprom_word, terminal_register_command_callback,
...
pub use numeric::{FixedRingIndex, MotorKinematics, SmoothAngle, angle_step, slew_toward};
