...
pub(crate) mod ffi {
    ...
    pub use selected_ffi::{
        ...
        imu_get_yaw, imu_startup_done, lbm_block_ctx_from_extension, lbm_car, lbm_cdr, lbm_cons,
        ...
        f_b, f_cons, f_float, f_i32, f_i64, f_lbm_array, f_sym, f_u32, f_u64, lbm_finish_flatten,
        ...
        lbm_unblock_ctx, lbm_unblock_ctx_unboxed,
