...
pub(crate) mod ffi {
    ...
    pub use selected_ffi::{
        ...
        mc_get_fault, mc_get_input_voltage_filtered, mc_get_odometer, mc_get_rpm,
        mc_get_sampling_frequency_now, mc_get_speed, mc_get_tachometer_abs_value,
        mc_get_tachometer_value, mc_get_tot_current_directional_filtered,
        ...
        mc_temp_fet_filtered, mc_temp_motor_filtered, mc_wait_for_motor_release, read_eeprom_word,
        read_nvm, store_eeprom_word, vesc_free, vesc_imu_get_quaternions, vesc_mutex_create,
