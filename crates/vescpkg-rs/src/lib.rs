...
pub(crate) mod ffi {
    ...
    pub use selected_ffi::{
        ...
        imu_set_yaw, imu_startup_done, lbm_block_ctx_from_extension, lbm_car, lbm_cdr, lbm_cons,
        ...
        lbm_finish_flatten, lbm_get_current_cid, lbm_get_symbol_by_name, lbm_is_byte_array,
