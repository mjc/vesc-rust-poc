...
pub(crate) mod ffi {
    ...
    pub use selected_ffi::{
        ...
        lbm_unblock_ctx, lbm_unblock_ctx_unboxed, mc_get_amp_hours, mc_get_amp_hours_charged,
        mc_get_battery_level, mc_get_distance, mc_get_distance_abs, mc_get_duty_cycle_now,
        mc_get_fault, mc_get_input_voltage_filtered, mc_get_odometer, mc_get_pid_pos_now,
        mc_get_pid_pos_set, mc_get_rpm, mc_get_sampling_frequency_now, mc_get_speed,
        mc_get_tachometer_abs_value, mc_get_tachometer_value, mc_get_tot_current,
        ...
        mc_set_duty_noramp, mc_set_handbrake, mc_set_handbrake_rel, mc_set_odometer,
        mc_set_pid_pos, mc_set_pid_speed, mc_stat_count_time, mc_stat_current_avg,
