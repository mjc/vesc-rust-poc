...
pub(crate) mod ffi {
    ...
    pub use vescpkg_rs_sys::raw::{
        ...
        can_status_msg_2_id, can_status_msg_3_id, can_status_msg_4_id, can_status_msg_id,
...
pub use can_bus::{
    CanBus, CanError, CanHardwareType, CanStatus, CanStatus2, CanStatus3, CanStatus4,
};
