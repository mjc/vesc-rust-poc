...
pub(crate) mod ffi {
    ...
    pub use selected_ffi::{
        ...
        mc_set_current, mc_set_current_off_delay, mc_set_duty, mc_set_handbrake,
        mc_set_handbrake_rel, mc_set_odometer, mc_set_pid_pos, mc_set_pid_speed,
        mc_stat_count_time, mc_stat_current_avg, mc_stat_current_max, mc_stat_power_avg,
        mc_stat_power_max, mc_stat_reset, mc_stat_speed_avg, mc_stat_speed_max,
