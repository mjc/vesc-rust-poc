...
fn generated_rust(slots: &[SlotDeclaration]) -> String {
    ...
    rust.push_str(".\n");
    rust.push_str("// Do not edit by hand; update the pinned official VESC header instead.\n\n");
    writeln!(
        rust,
    ...
    writeln!(
        rust,
        "pub(crate) const FIRMWARE_700_FIRST_SLOT: usize = {};",
        slot_index(slots, "foc_set_fw_override")
    )
    .expect("write generated Rust");
    rust.push('\n');
