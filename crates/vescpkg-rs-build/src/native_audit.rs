...
/// Asserts that loader init code talks to firmware only through the `vescpkg-rs-sys` surface.
pub fn assert_rust_loader_init_uses_vescpkg_sys(init_disassembly: &str) {
    assert!(
