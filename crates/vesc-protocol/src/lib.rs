...
//! in the current `vescpkg-rs-units` crate, VESC-domain semantic values belong in the
//! future `vescpkg-rs-types` crate, and third-party `uom` compatibility should remain
