...
///
/// C map: `adc_left`, `adc_right`, and `state` in the pinned cutoff's
/// `third_party/float-out-boy/src/footpad_sensor.h`.
...
impl FloatOutBoyFootpadSample {
    ...
    ///
    /// C map: the pinned cutoff stores the mapping-adjusted values in
