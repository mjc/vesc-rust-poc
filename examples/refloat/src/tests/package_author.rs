use crate::domain::{
    ...
    RefloatHardwareLedsConfig, RefloatImuSample, RefloatLedAnimationMode, RefloatLedAnimationSpeed,
    RefloatLedBarConfig, RefloatLedColor, RefloatLedColorOrder, RefloatLedMode, RefloatLedPin,
    RefloatLedPinConfig, RefloatLedStripConfig, RefloatLedStripOrder, RefloatLedTransition,
    RefloatLedsConfig, RefloatMode, RefloatMotorCommand, RefloatMotorTelemetry,
...
fn package_author_encodes_all_data_base_response_like_refloat_v1_2_1() {
    ...
    assert_eq!(
        ...
        [
            101, 10, 1, 0, 90, 0, 12, 255, 251, 33, 18, 30, 20, 133, 128, 123, 138, 118, 143, 0,
            23, 132, 2, 208, 4, 176, 0, 30, 0, 50, 255, 236, 103, 6,
        ]
    );
}
...
fn package_author_encodes_all_data_mode4_response_like_refloat_v1_2_1() {
    ...
    assert_eq!(
        ...
        [
            101, 10, 4, 0, 90, 0, 12, 255, 251, 33, 18, 30, 20, 133, 128, 123, 138, 118, 143, 0,
            23, 132, 2, 208, 4, 176, 0, 30, 0, 50, 255, 236, 103, 6, 66, 128, 0, 0, 88, 103, 0, 0,
...
fn package_author_dispatches_all_data_responses_from_typed_request_mode() {
    ...
    assert_eq!(
        payloads
            ...
            .as_bytes(),
        &[
            101, 10, 2, 0, 90, 0, 12, 255, 251, 33, 18, 30, 20, 133, 128, 123, 138, 118, 143, 0,
            23, 132, 2, 208, 4, 176, 0, 30, 0, 50, 255, 236, 103, 6, 66, 128, 0, 0, 88, 103, 0,
        ]
    );
    assert_eq!(
        payloads
            ...
            .as_bytes(),
        &[
            101, 10, 3, 0, 90, 0, 12, 255, 251, 33, 18, 30, 20, 133, 128, 123, 138, 118, 143, 0,
            23, 132, 2, 208, 4, 176, 0, 30, 0, 50, 255, 236, 103, 6, 66, 128, 0, 0, 88, 103, 0, 0,
    ...
    assert_eq!(
        payloads
            ...
            .as_bytes(),
        &[
            101, 10, 9, 0, 90, 0, 12, 255, 251, 33, 18, 30, 20, 133, 128, 123, 138, 118, 143, 0,
            23, 132, 2, 208, 4, 176, 0, 30, 0, 50, 255, 236, 103, 6, 66, 128, 0, 0, 88, 103, 0, 0,
            1, 226, 64, 0, 32, 0, 8, 0, 170, 0, 18, 144, 0, 12, 3, 56,
        ]
    );
