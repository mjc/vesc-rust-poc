// C map: Refloat averages ERPM deltas over this many samples at
// `third_party/refloat/src/motor_data.h:26`.
...
impl AccelerationHistoryIndex {
    ...
    fn replace(
        ...
        // C map: `third_party/refloat/src/motor_data.c:128-133` swaps one
...
impl MotorAccelerationTracker {
    pub(super) fn record(&mut self, motor_erpm: vescpkg_rs::prelude::Rpm) {
        // C map: `third_party/refloat/src/motor_data.c:128-133` subtracts the previous ERPM,
...
mod tests {
    ...
    #[test]
    fn acceleration_history_index_wraps_inside_refloat_window() {
    ...
    #[test]
    fn record_matches_refloat_rolling_erpm_delta_average() {
        ...
        // Refloat replaces the oldest 10 ERPM sample with the current 40 ERPM sample:
