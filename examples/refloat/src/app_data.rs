...
use self::protocol::encode_refloat_realtime_data_response;
use crate::config::*;
...
pub use self::lifecycle::RefloatAppDataLifecycle;
#[cfg(all(not(test), target_arch = "arm"))]
pub use self::startup::{
    install_refloat_app_data, install_refloat_app_data_state, register_refloat_app_data_callbacks,
};
...
mod tests {
    ...
    use super::test_support::{
        RecordingAppDataBindings, sample_all_data_payloads,
