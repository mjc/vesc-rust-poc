//! Refloat app-data protocol types.
//!
...
//! (`0ef6e99d8701`):
//! - `third_party/refloat/src/main.c:1241-1262` defines the core app-data command IDs.
//! - `third_party/refloat/src/lcm.h:27-33` and `third_party/refloat/src/charging.h:25`
//!   define LCM/charging command IDs.
//! - `third_party/refloat/src/main.c:2210-2215` defines `COMMAND_GET_ALLDATA`.
//! - `third_party/refloat/src/main.c:1313-1399` defines the all-data response layout.

/// Refloat app-data package ID; upstream writes literal `101` in
/// `third_party/refloat/src/main.c:1271`, `1318`, `1881`, and `1909`.
...
///
/// Refloat `v1.2.1` defines the core IDs in `third_party/refloat/src/main.c:1241-1262`,
/// LCM IDs in `third_party/refloat/src/lcm.h:27-33`, and charging state in
/// `third_party/refloat/src/charging.h:25`.
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash)]
...
impl RefloatAllDataRequest {
    ...
    ///
    /// Upstream dispatches this command at `third_party/refloat/src/main.c:2210-2215`
    /// and encodes responses in `third_party/refloat/src/main.c:1313-1399`.
