...
impl RefloatConfigEditor<'_> {
    pub(crate) fn apply_flywheel_overrides(&mut self, config: RefloatFlywheelConfig) -> bool {
        self.apply_handtest_safety_overrides()
            ...
            && RefloatFaultConfig::PITCH_FIELD
                .write(self, AngleDegrees::from_degrees(6.0))
                .is_some()
            && RefloatFaultConfig::ROLL_FIELD
                .write(
                    self,
