...
use crate::domain::RefloatRealtimeRuntimeSetpoint;
use vescpkg_rs::Rpm;
...
impl Direction {
    ...
    fn from_proportional(proportional: Proportional) -> Self {
        ...
        // proportional angle at `third_party/refloat/src/booster.c:63-72`.
...
impl Branch {
    ...
    pub(super) fn from_motor_current(motor_current: MotorCurrent) -> Self {
        ...
        // the sign of the current at `third_party/refloat/src/booster.c:32-45`.
    ...
    fn profile(self, config: LoopConfig) -> Profile {
        // C map: `third_party/refloat/src/booster.c:32-45` picks the accel
...
impl RampOffset {
    ...
    fn from_profile(proportional: Proportional, profile: Profile) -> Self {
        // C map: `third_party/refloat/src/booster.c:63-72` compares the
    ...
    fn range(self, ramp: AngleDegrees) -> Range {
        // C map: `third_party/refloat/src/booster.c:63-72` uses deadband,
...
impl SpeedStiffness {
    ...
    fn from_abs_erpm(abs_erpm: Rpm) -> Self {
        // C map: `third_party/refloat/src/booster.c:48-51` starts stiffness
    ...
    fn boosted_current(self, current: MotorCurrent) -> MotorCurrent {
        ...
        // `third_party/refloat/src/booster.c:52-54`.
    ...
    fn softened_angle(self, angle: AngleDegrees) -> AngleDegrees {
        ...
        // `third_party/refloat/src/booster.c:55-59`.
        angle / (1.0 + self.0)
    }
}
...
impl Profile {
    ...
    fn with_speed_stiffness(self, branch: Branch, motor_erpm: ElectricalSpeed) -> Self {
        // C map: `third_party/refloat/src/booster.c:48-60` scales current or
...
impl Phase {
    ...
    pub(super) const fn from_step(config: LoopConfig, input: LoopInput) -> Self {
        // C map: `third_party/refloat/src/booster.c:32-75` runs from the
    ...
    pub(super) fn filtered_current(self, previous: MotorCurrent) -> MotorCurrent {
        // C map: `third_party/refloat/src/booster.c:74-75` filters the newly
