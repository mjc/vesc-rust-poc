...
impl<Tag> AngularRateAxis<Tag> {
    ...
    pub(super) const fn new(value: AngularVelocity) -> Self {
        ...
        // `third_party/refloat/src/main.c:760-765` and
        // `third_party/refloat/src/balance_filter.c:73-76`.
...
impl<Tag> AngularHalfStepAxis<Tag> {
    ...
    const fn new(value: AngleRadians) -> Self {
        ...
        // `third_party/refloat/src/balance_filter.c:114-117`.
        Self(value, core::marker::PhantomData)
    }
}
...
impl MeasuredAngularRate {
    ...
    fn from_axes(
        ...
        // C map: Refloat forwards the callback gyro sample into `balance_filter_update`
        // at `third_party/refloat/src/main.c:760-765`; the filter integrates those axes
        // at `third_party/refloat/src/balance_filter.c:73-76`.
        Self::new(
