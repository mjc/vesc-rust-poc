...
use vescpkg_rs::{AppDataHandler, AppDataPacket, AppDataReply, Firmware, PackageStart};
...
impl AppDataHandler for LoopbackAppData {
    ...
    fn handle(_state: &mut Self::State, packet: AppDataPacket<'_>, reply: &mut AppDataReply<'_>) {
