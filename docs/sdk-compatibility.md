...
| Usage-shaped package ports | `examples/loopback` covers a typed LispBM extension, app-data transport, and explicit EEPROM read/write through `Firmware::eeprom()` | The probe address is example-owned; persistence is opt-in and remains firmware policy |
